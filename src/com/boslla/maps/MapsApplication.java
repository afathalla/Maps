...
import org.vaadin.hezamu.googlemapwidget.MyPoint2D;
...
//		googleMap = new GoogleMap(this, new MyPoint2D(31.22889,30.05806), 11);
		...
		upperSearchButton.addListener(new Button.ClickListener() {
            public void buttonClick(ClickEvent event) {
        		...
        		if (upperSearchText.getValue() != null)
        		{
			  			...
			  			final PlaceContainer placeContainer = PlaceContainer.getPlace(upperSearchText.getValue().toString());
...
//		}
	...
	{
	    //GoogleMap googleMap = new GoogleMap(this, new MyPoint2D(22.3, 60.4522), 8);
		//googleMap.addMarker(new BasicMarker(1L, new MyPoint2D(31.345657,30.073244), "Test marker"));
		
		googleMap.setCenter(new MyPoint2D(31.22889,30.05806));
		...
		for (int i=0;i<placeContainer.size();i++)
		{
			...
			BasicMarker basicMarker = new BasicMarker( l, new MyPoint2D( placeContainer.getIdByIndex(i).getPlaceLongitude(), placeContainer.getIdByIndex(i).getPlaceLatitude()), placeContainer.getIdByIndex(i).getPlaceName());
	...
	protected void setGoogleMap(PlaceContainer placeContainer, Place place) {
		...
		googleMap.setCenter(new MyPoint2D(place.getPlaceLongitude(),place.getPlaceLatitude()));
